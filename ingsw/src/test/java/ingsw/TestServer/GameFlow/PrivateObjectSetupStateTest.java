...
public class PrivateObjectSetupStateTest {
    ...
    @Test public void testSetup() {
        ...
        Assert.assertEquals(gameFH.gridSetupState, gameFH.getCurrent());
    }
}
